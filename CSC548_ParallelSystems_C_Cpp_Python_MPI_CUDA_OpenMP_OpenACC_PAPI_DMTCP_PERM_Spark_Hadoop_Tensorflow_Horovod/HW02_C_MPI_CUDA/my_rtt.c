 ...
 *
 * HW02 CHANGE:     Accept task rank, number of tasks, and name of port list file as arguments.
 *                  Pass these arguments to MPI_Init
 *
 ...
 *
 * HW02 CHANGE:     Ensure that sendcount argument to MPI_Gatherv is ZERO
...
void gatherResults () {
    ...
    // How many does this node send?
    if (nMyRank % 2 == 0) {
        nSendCount = nResultsReportedFromEachPair;
    }
    else {
        nSendCount = 0;
    }
