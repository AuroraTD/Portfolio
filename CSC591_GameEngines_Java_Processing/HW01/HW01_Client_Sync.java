 ...
 *
 * TO COMPILE:      javac -classpath .:./core.jar HW01_Client_Sync.java
 * 
 * TO RUN:          java -classpath .:./core.jar HW01_Client_Sync
 *************************************************************************************************************/
...
// CLASS DEFINITION
public class HW01_Client_Sync extends PApplet {
    ...
    public void draw () {
        try {
            ...
            if (bQuit == true) {
                ...
                // Carry on only if the server appears to still be up
                if (bQuit != true) {
                    
                    // Clear player objects (will get fresh from server)
