...
// CLASS DEFINITION
public class HW02_ObjectDeathZone extends HW02_ObjectCollidable {
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public HW02_ObjectDeathZone (int nExistingGUID, int nX_px, int nY_px, int nWidth_px, int nHeight_px) {
