...
// CLASS DEFINITION
public class HW03_Timer implements java.io.Serializable {
    ...
    /*********************************************************************************************************
     * FUNCTION:        HW03_Timer Constructor
     *
     * AUTHOR:          attiffan    Aurora T. Tiffany-Davis
     *
     ...
     *********************************************************************************************************/
    public void start () {
        this.nStartTimeReal = HW03_Time_Real.getInstance().getTime();
        this.nStartTimeGame = HW03_Time_Game.getInstance().getTime();
        this.nStartTimeLoop = HW03_Time_Loop.getPlayInstance().getTime();
        this.bIsTiming = true;
    }
     ...
     *********************************************************************************************************/
    public void stop () {
        this.nEndTimeReal = HW03_Time_Real.getInstance().getTime();
        this.nEndTimeGame = HW03_Time_Game.getInstance().getTime();
        this.nEndTimeLoop = HW03_Time_Loop.getPlayInstance().getTime();
    ...
    public double getElapsedTimeReal () {
        return this.nEndTimeReal < 0 ? 
            (HW03_Time_Real.getInstance().getTime() - this.nStartTimeReal) : 
    ...
    public double getElapsedTimeGame () {
        ...
        return this.nEndTimeGame < 0 ? 
            (HW03_Time_Game.getInstance().getTime() - this.nStartTimeGame) : 
    ...
    public double getElapsedTimeLoop () {
        ...
        return this.nEndTimeLoop < 0 ? 
            (HW03_Time_Loop.getPlayInstance().getTime() - this.nStartTimeLoop) : 
