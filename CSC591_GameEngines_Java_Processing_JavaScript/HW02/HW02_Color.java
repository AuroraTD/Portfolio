...
// CLASS DEFINITION
public class HW02_Color implements java.io.Serializable {
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public HW02_Color (int R, int G, int B) {
        try {
            this.R = R;
            this.G = G;
            this.B = B;
     ...
     *********************************************************************************************************/
    public static HW02_Color getRandomShade (String sColor) {
        
        HW02_Color oColor = null;
        try {
     ...
     *********************************************************************************************************/
    public static HW02_Color getInverse (HW02_Color oColorIn) {
        
        return new HW02_Color(
            255 - oColorIn.R,
            255 - oColorIn.G,
            255 - oColorIn.B
        );
