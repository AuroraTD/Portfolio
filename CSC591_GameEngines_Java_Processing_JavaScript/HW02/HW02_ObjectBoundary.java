...
// CLASS DEFINITION
public class HW02_ObjectBoundary extends HW02_ObjectCollidable {
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public HW02_ObjectBoundary (int nExistingGUID, int nX_px, int nY_px, int nLength_px, boolean bVertical) {
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public HW02_ObjectBoundary (int nExistingGUID, int nX_px, int nY_px, int nWidth_px, int nHeight_px) {
