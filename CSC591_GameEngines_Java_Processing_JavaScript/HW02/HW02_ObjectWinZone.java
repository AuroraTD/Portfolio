...
// CLASS DEFINITION
public class HW02_ObjectWinZone extends HW02_ObjectCollidable {
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public HW02_ObjectWinZone (int nExistingGUID, int nX_px, int nY_px, int nWidth_px, int nHeight_px) {
