...
// CLASS DEFINITION
public abstract class HW04_ObjectMoveable extends HW04_ObjectRenderable {
    ...
    /*********************************************************************************************************
     * FUNCTION:        HW04_ObjectMoveable Constructor
     *
     * AUTHOR:          attiffan    Aurora T. Tiffany-Davis
     *
    ...
    /*********************************************************************************************************
     * FUNCTION:        updateLocationAndCheckForCollisions
     *
     * AUTHOR:          attiffan    Aurora T. Tiffany-Davis
     *
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public void updateLocationAndCheckForCollisions () {
        ...
        try {
            ...
            this.checkForCollisionsAndRaiseEvent();
    ...
    *********************************************************************************************************/
    ...
    public void backOutOfCollision (float nOriginalX, float nOriginalY) {
        ...
        try {
            ...
            int i;
            Random oRandom;
            CopyOnWriteArrayList<HW04_ObjectCollidable> oCollidedObjects;
            HW04_ObjectCollidable oSomeCollidedObject;
            ...
            while (true) {
                ...
                if (
                    ...
                    if (oSomeCollidedObject instanceof HW04_ObjectPlatform) {
                    ...
                    else if (oSomeCollidedObject instanceof HW04_ObjectBoundary) {
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public void backAwayFromObjectX (HW04_ObjectCollidable oObject, boolean bGoToLeft) {
         
        try {
            
            // Declare constants
            final float N_SCOOCH_PX = (float) 3;
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public void backAwayFromObjectY (HW04_ObjectCollidable oObject, boolean bGoToTop) {
