...
// CLASS DEFINITION
public abstract class HW04_ObjectStatus extends HW04_ObjectRenderable {
    
    // Required for serializable class
    private static final long serialVersionUID = 1L;
    
    // Object properties
    private final static HW04_Color O_COLOR =       new HW04_Color(
                                                        HW04_Color.white(), 
                                                        HW04_Color.white(), 
                                                        HW04_Color.white()
                                                    );
    ...
    private final static int N_WIDTH_PX =           HW04_Utility.getWindowSize();
    private final static int N_RADIUS_PX =          0;
    private final static int N_MARGIN_PX =          4;
    private final static int N_HEIGHT_PX =          HW04_ObjectRenderable.getStaticFontSize() + N_MARGIN_PX * 2;
    private static int nNumStatusObjects =          0;
    
    /*********************************************************************************************************
     * FUNCTION:        HW04_ObjectStatus Constructor
     *
     * AUTHOR:          attiffan    Aurora T. Tiffany-Davis
     *
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public HW04_ObjectStatus (int nExistingGUID, PApplet oApplet) {
