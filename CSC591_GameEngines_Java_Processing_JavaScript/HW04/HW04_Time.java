...
// CLASS DEFINITION
public abstract class HW04_Time implements HW04_EventObserver, java.io.Serializable {
    
    // Required for serializable class
    private static final long serialVersionUID =                    1L;
    
    // Private constants
    private static HW04_EventManager O_EVENT_MANAGER =              HW04_EventManager.getInstance();
    
    // Private variables
    private static ConcurrentHashMap<String, HW04_Timer> oTimers =  new ConcurrentHashMap<String, HW04_Timer>();
    ...
    /*********************************************************************************************************
     * FUNCTION:        HW04_Time Constructor
     *
     * AUTHOR:          attiffan    Aurora T. Tiffany-Davis
     *
    ...
    public HW04_Time () {
        try {
            ...
            if (nTimelineInstances == 0) {
                 ...
                 */
                O_EVENT_MANAGER.registerForEvents(HW04_ObjectEvent.EventType.GAME_PAUSE, this, true);
    ...
    private static void pauseGame () {
        try {
            ...
            // Pause game and loop time
                ...
                HW04_Time_Game.getInstance().pause();
                HW04_Time_Loop.getPlayInstance().pause();
            }
    ...
    public static boolean isGamePaused () {
        ...
        return HW04_Time_Game.getInstance().isPaused() || HW04_Time_Loop.getPlayInstance().isPaused();
    ...
    private static void resumeGame () {
        try {
            ...
            // Resume game and loop time
                ...
                HW04_Time_Game.getInstance().resume();
                HW04_Time_Loop.getPlayInstance().resume();
            }
    ...
    public static void startTimer (String sTimerName) {
        ...
        try {
            ...
            // Add a new timer to the hash map
                ...
                oTimers.put(sTimerName, new HW04_Timer());
            }
    ...
    public synchronized void handleEvent (HW04_ObjectEvent oEventToHandle) {
        try {
             ...
             */
            if (oEventToHandle.getEventType() == HW04_ObjectEvent.EventType.GAME_PAUSE) {
