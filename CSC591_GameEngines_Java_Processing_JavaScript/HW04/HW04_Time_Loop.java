...
// CLASS DEFINITION
public class HW04_Time_Loop extends HW04_Time {
    
    // Required for serializable class
    private static final long serialVersionUID =    1L;
    
    // Private variables
    private static HW04_Time_Loop oPlayInstance =   null;
    private static HW04_Time_Loop oReplayInstance = null;
    ...
    /*********************************************************************************************************
     * FUNCTION:        HW04_Time_Loop Constructor
     *
     * AUTHOR:          attiffan    Aurora T. Tiffany-Davis
     *
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public static HW04_Time_Loop getPlayInstance () {
        if (oPlayInstance == null) {
            oPlayInstance = new HW04_Time_Loop();
        }
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public static HW04_Time_Loop getReplayInstance () {
        if (oReplayInstance == null) {
            oReplayInstance = new HW04_Time_Loop();
        }
    ...
    void start () {
        ...
        try {
            ...
            if (this.isStarted() == true) {
                ...
                this.nTimeGameLastIteration_ms = HW04_Time_Game.getInstance().getTime();
                // Note that the loop time has started
                HW04_EventManager.getInstance().raiseEventAdmin("Loop Time Started");
            }
    ...
    public void tick () {
         ...
         */
        nGameTimeCurrent_ms = HW04_Time_Game.getInstance().getTime();
