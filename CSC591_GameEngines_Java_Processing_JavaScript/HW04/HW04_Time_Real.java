...
// CLASS DEFINITION
public class HW04_Time_Real extends HW04_Time {
    
    // Required for serializable class
    private static final long serialVersionUID =    1L;
    
    // Private variables
    private static HW04_Time_Real oInstance =       null;
    
    /*********************************************************************************************************
     * FUNCTION:        HW04_Time_Real Constructor
     *
     * AUTHOR:          attiffan    Aurora T. Tiffany-Davis
     *
     ...
     * RETURNS:         None
     *********************************************************************************************************/
    public static HW04_Time_Real getInstance () {
        if (oInstance == null) {
            oInstance = new HW04_Time_Real();
        }
        return oInstance;
    }
